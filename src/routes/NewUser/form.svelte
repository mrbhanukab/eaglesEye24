...
<MainLayout {imgSrc}>
 {#snippet aboveImage()}
  <div class="newUserPageAboveImage">
   ...
   <p>Please fill in the fields below with your information. Once submitted, we'll send a One-Time Password (OTP) to the email address you provide. Check your email (including your spam/junk folder) for the OTP, which is required to verify your account. After verification, you'll gain access to your account.</p>
  </div>
 {/snippet}
 {#snippet right()}
