<script>
 ...
 async function fetchData() {
  ...
  console.log(currentUser); // Log currentUser after fetching data
 }

 onMount(() => {
  // Ensure fetchData is called when the component mounts
  fetchData();
 });
...
<div class="container">
 <section class="component aetos" style="margin-left: 0.8vw"></section>
 <section class="right" style="margin-right: 0.8vw">
  <div class="component aetosMindAndXploratus">
   <div class="subComponent aetosMind" style="margin-top: 1.2vh">1</div>
   <div class="subComponent Xploratus" style="margin-bottom: 1.2vh">2</div>
  </div>
  <header class="header">
   ...
   <div class="component eventLogo">
    ...
    <span class="collaboration">
      ...
      <img src={`data:image/png;base64, ${logos?.airForce}`} alt="air force logo" draggable="false" />
          <img class="icacLogo" src={`data:image/png;base64, ${logos?.icac}`} alt="ICAC logo"
             draggable="false" />
